  ...
  <body>
    <div class="container">
      ...
      <section class="seccionRegistro">
        <h3>Por favor, complete con sus datos para el registro</h3>
        <form class="" action="index.html" method="post">
          <div class="form-group">
            <label for="" class="labelForm">Nombre</label>
            <input type="text" name="" value="" class="input-cris">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="email" name="" value="" class="input-cris">
          </div>
          <div class="form-group">
            <label for="" class="labelForm">Contraseña</label>
            <input type="password" name="" value="" class="input-cris">
          </div>
          <br>
          <div class="labelForm">
